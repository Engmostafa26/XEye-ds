...
try:
    ...
    print("[Info] --> If you have any questions or need help, please message us on our academy contact page \"https://academy.XEyecs.com/contact" ")
